...
<title>cHAPTER 1 rISKS OF tHREADS</title>
<% session.setAttribute("key","1_7");%>
</head>
<div id="menu">
<ul>
...
<td>
<div id="post">
<h3>cHAPTER 1 rISKS OF tHREADS</h3>
...
<a href="../chapter1/1_6moreresponsiveuserinterfaces.jsp"> << Previous</a>
<a href="../TableOfContentJava.jsp"> TOC </a>
<a href="../chapter1/1_9safetyhazards.jsp">Next >> </a>
