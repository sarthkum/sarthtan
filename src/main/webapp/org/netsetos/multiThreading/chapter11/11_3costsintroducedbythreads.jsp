...
<title>cHAPTER 11 cOSTS  iNTRODUCED  BY  tHREADS</title>
<% session.setAttribute("key","11_3");%>
</head>
<div id="menu">
<ul>
...
<td>
<div id="post">
<h3>cHAPTER 11 cOSTS  iNTRODUCED  BY  tHREADS</h3>
...
<a href="../chapter11/11_2amdahlslaw.jsp"> << Previous</a>
<a href="../TableOfContentJava.jsp"> TOC </a>
<a href="../chapter11/11_4reducinglockcontention.jsp">Next >> </a>
