...
<title>cHAPTER 4 dESIGNING  A  tHREAD  SAFE  cLASS</title>
<% session.setAttribute("key","4_");%>
</head>
<div id="menu">
<ul>
...
<td>
<div id="post">
<h3>cHAPTER 4 dESIGNING  A  tHREAD  SAFE  cLASS</h3>
...
<a href="../chapter3/3_5safepublication.jsp"> << Previous</a>
<a href="../TableOfContentJava.jsp"> TOC </a>
<a href="../chapter4/4_2instanceconfinement.jsp">Next >> </a>
