...
<title>cHAPTER 8 bEWARE OF cLASHES AFTER eRASURE</title>
<% session.setAttribute("key","8_6_1");%>
</head>
<div id="menu">
<ul>
...
<td>
<div id="post">
<h3>cHAPTER 8 bEWARE OF cLASHES AFTER eRASURE</h3>
...
<a href="../chapter8/8_6restrictionsandlimitations.jsp"> << Previous</a>
<a href="../TableOfContentJava.jsp"> TOC </a>
<a href="../chapter8/8_6_2runtimetypeinquiryonlyworkswithrawtypes.jsp">Next >> </a>
