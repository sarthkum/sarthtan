...
<title>cHAPTER 6 vARIABLE sCOPE</title>
<% session.setAttribute("key","6_3_6");%>
</head>
<div id="menu">
<ul>
...
<td>
<div id="post">
<h3>cHAPTER 6 vARIABLE sCOPE</h3>
...
<a href="../chapter6/6_3_5constructorreferences.jsp"> << Previous</a>
<a href="../TableOfContentJava.jsp"> TOC </a>
<a href="../chapter6/6_3_7processinglambdaexpressions.jsp">Next >> </a>
