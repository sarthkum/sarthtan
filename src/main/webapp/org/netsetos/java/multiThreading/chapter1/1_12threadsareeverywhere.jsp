...
<title>cHAPTER 1 tHREADS ARE eVERYWHERE</title>
<% session.setAttribute("key","1_12");%>
</head>
<div id="menu">
<ul>
...
<td>
<div id="post">
<h3>cHAPTER 1 tHREADS ARE eVERYWHERE</h3>
...
<a href="../chapter1/1_11performancehazards.jsp"> << Previous</a>
<a href="../TableOfContentJava.jsp"> TOC </a>
<a href="../chapter2/2_1whatisthreadsafety.jsp">Next >> </a>
