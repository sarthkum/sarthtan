...
<title>cHAPTER 8 iMPLICIT  cOUPLINGS  bETWEEN  tASKS  AND  eXECUTION  pOLICIES</title>
<% session.setAttribute("key","8_");%>
</head>
<div id="menu">
<ul>
...
<td>
<div id="post">
<h3>cHAPTER 8 iMPLICIT  cOUPLINGS  bETWEEN  tASKS  AND  eXECUTION  pOLICIES</h3>
...
<a href="../chapter7/7_4jvmshutdownsummary.jsp"> << Previous</a>
<a href="../TableOfContentJava.jsp"> TOC </a>
<a href="../chapter8/8_2sizingthreadpools.jsp">Next >> </a>
