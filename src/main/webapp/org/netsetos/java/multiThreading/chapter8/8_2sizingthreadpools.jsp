...
<title>cHAPTER 8 sIZING  tHREAD  pOOLS</title>
<% session.setAttribute("key","8_2");%>
</head>
<div id="menu">
<ul>
...
<td>
<div id="post">
<h3>cHAPTER 8 sIZING  tHREAD  pOOLS</h3>
...
<a href="../chapter8/8_1implicitcouplingsbetweentasksandexecutionpolicies.jsp"> << Previous</a>
<a href="../TableOfContentJava.jsp"> TOC </a>
<a href="../chapter8/8_3configuringthreadpoolexecutor.jsp">Next >> </a>
