...
<title>cHAPTER 13 aCCESSING iMAGE AND aUDIO fILES</title>
<% session.setAttribute("key","13_4_4");%>
</head>
<div id="menu">
<ul>
...
<td>
<div id="post">
<h3>cHAPTER 13 aCCESSING iMAGE AND aUDIO fILES</h3>
...
<a href="../chapter13/13_4_3useofparameterstopassinformationtoapplets.jsp"> << Previous</a>
<a href="../TableOfContentJava.jsp"> TOC </a>
<a href="../chapter13/13_4_5theappletcontext.jsp">Next >> </a>
