...
<title>cHAPTER 13 tHE APPLET html tAG AND iTS aTTRIBUTES</title>
<% session.setAttribute("key","13_4_2");%>
</head>
<div id="menu">
<ul>
...
<td>
<div id="post">
<h3>cHAPTER 13 tHE APPLET html tAG AND iTS aTTRIBUTES</h3>
...
<a href="../chapter13/13_4_1asimpleapplet.jsp"> << Previous</a>
<a href="../TableOfContentJava.jsp"> TOC </a>
<a href="../chapter13/13_4_3useofparameterstopassinformationtoapplets.jsp">Next >> </a>
