...
<title>cHAPTER 4 dISSECTING THE eMPLOYEE cLASS</title>
<% session.setAttribute("key","4_3_3");%>
</head>
<div id="menu">
<ul>
...
<td>
<div id="post">
<h3>cHAPTER 4 dISSECTING THE hORSE cLASS</h3>
<p>We will try to dissect the Horse class , Lets start with methods </p> 

 

<p>It has four methods and a constructor </p> 

<pre> 

Horse(int, String, int, String) 
...
<p>All methods of this class are tagged as public. The keyword public means that any method in any class can call the method. (The four possible access levels are covered in this and the next chapter.)</p> 

 

<p>Next, notice the three instance fields that will hold the data manipulated inside an instance of the Horse class</p> 
...
and an enum Sounds with different horse sound. 
...
<p>We have access as private for instance variable so that no body could change it behavoir from other class without the methods of the class</p> 

 

<p>The private keyword makes sure that the only methods that can access these instance fields are the methods of the Horse class itself. No outside method can read or write to these fields.</p> 

 

<p>Finally, notice that two of the instance fields are themselves objects: The breed  and date fields are references to String and LocalDate objects. This is quite usual: Classes will often contain instance fields of class type.</p> 
...
<a href="../chapter4/4_3_2useofmultiplesourcefiles.jsp"> << Previous</a>
<a href="../TableOfContentJava.jsp"> TOC </a>
<a href="../chapter4/4_3_4firststepswithconstructors.jsp">Next >> </a>
