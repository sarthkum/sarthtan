...
<title>cHAPTER 4 pARAMETER nAMES</title>
<% session.setAttribute("key","4_6_5");%>
</head>
<div id="menu">
<ul>
...
<td>
<div id="post">
<h3>cHAPTER 4 pARAMETER nAMES</h3>
<p>When you write very trivial constructors than name these constructor with some parameter names that are related to the task </p> 

 

<p>Instead of below constructor </p> 

 

<pre> 

    public Horse(int x, String y, int m, String n) { 
...
<p>We can write like below which would be good for debugging and troubleshooting laters</p> 
...
<a href="../chapter4/4_6_4explicitfieldinitialization.jsp"> << Previous</a>
<a href="../TableOfContentJava.jsp"> TOC </a>
<a href="../chapter4/4_6_6callinganotherconstructor.jsp">Next >> </a>
