...
<title>cHAPTER 4 cLASS iMPORTATION</title>
<% session.setAttribute("key","4_7_1");%>
</head>
<div id="menu">
<ul>
...
<td>
<div id="post">
<h3>cHAPTER 4 cLASS iMPORTATION</h3>
<p>A class can use all classes from its own package and all public classes from other package.</p> 

 

<p>You can acess the public classes in another package in two ways. The first is to simply add full package name before every class name</p> 

 

<pre>org.troubleshoot.Node n1 = new Node(2);</pre> 

 

<p>That is oviously tedious. A common and simple approach is to use import statement. The point of the import statement is to give you a short hand to refer to the classes in the package. Once you use import you no longer have to give classes there full name.</p> 

 

<p>You can import a specific class or a whole package.You have to use the import statement above class name and below any package name. </p> 
...
<p>You can also import only the class that you want to use like below</p> 
...
<p>The java.util.* syntax is less tedious. It has no negative effect on code size. However, if you import classes explicitly, the reader of your code knows exactly which classes you use.      </p> 

 

<p> In Eclipse, you can select the menu option Source - Organize Imports. Package statements such as import java.util.*; are automatically expanded into a list of specific imports such as</p> 
...
<p>This is an extremely convenient feature.</p> 

<p> 

However note that you can only use the * notation to import a single package. You cannot use import java* and java.*.* to import all the packages.</p>  

 

<p>Most of the time you import packages without worrying about them. But in some cases where there are classes with same name in different packages you need to take care which one to use like Date class is present in both packages </p> 
...
<p>If you now use the Date class, you get a compile-time error:</p> 

 

<pre>Date today; // Error--java.util.Date or java.sql.Date?</pre> 

 

<p>What if you really need both Date classes? Then you need to use the full package name with every class name.</p> 
...
<a href="../chapter4/4_7packages.jsp"> << Previous</a>
<a href="../TableOfContentJava.jsp"> TOC </a>
<a href="../chapter4/4_7_2staticimports.jsp">Next >> </a>
