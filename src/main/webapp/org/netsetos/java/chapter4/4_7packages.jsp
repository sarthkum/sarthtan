...
<title>cHAPTER 4 pACKAGES</title>
<% session.setAttribute("key","4_7");%>
</head>
<div id="menu">
<ul>
...
<td>
<div id="post">
<h3>cHAPTER 4 pACKAGES</h3>
<p>Java allows you to group classes in  a collection called a package. Package are convinient for organizing your work from code libraries provided by others.</p> 

 

<p>The standard java library is distributed over a number of packages, including java.lang, java.util, java.net , and so on. The  standard Java pacjages are example of hierarical packages. Just as you have nested sub directories on your hard disk. It is like organizing the content in different folders.</p> 

 

<p>The main reason for using packages is to give uniqueness to the class name . Suppose two programmers come up with a different idea for Login into a application with a Login Class. There is no conflicy at all untill they are in different packages.</p> 

 

<p>You can also think of the package as the inverse of the domain name like </p> 

 

<p>www.netsetos.com so the package will be like com.netsetos.util or com.netsetos.corejava or com.netsetos only </p> 

 

<p>From the point of view of compiler there is no relation between the nested packages.    </p> 
...
<a href="../chapter4/4_6_8objectdestructionandthefinalizemethod.jsp"> << Previous</a>
<a href="../TableOfContentJava.jsp"> TOC </a>
<a href="../chapter4/4_7_1classimportation.jsp">Next >> </a>
