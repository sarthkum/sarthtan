...
<title>cHAPTER 4 fIRST sTEPS WITH cONSTRUCTORS</title>
<% session.setAttribute("key","4_3_4");%>
</head>
<div id="menu">
<ul>
...
<td>
<div id="post">
<h3>cHAPTER 4 fIRST sTEPS WITH cONSTRUCTORS</h3>
<p>Lets see the contructor listed in our Horse Class</p> 
...
<p>As you can see , the name of the constructor is the same as the name of the class This constructor runs when you  construct object of the Horse class giving the instance fields the initial state you want them to have <p> 

 

<pre>new Horse(16, "Brown", 100, "Arbaic");</pre> 

 

<p>There is an important difference between a method and constructor. A constructor can only called in conjuction with the new operator. </p> 

 

<p>It can be made only through new keyword only.</p> 

 

<ol> 

<li>A constructor has same name as the class</li> 

<li>A class can  have  more than one constructor </li> 

<li>A constructor has no return value </li> 

<li>A constructor is always called with a new keyword</li> 
...
<p>Be carefull do not use the local variable in a constructor like below </p> 
...
<p>They are not usefull as they are in local scope.You just have to be careful in all of your methods to not use variable names that equal the names of instance fields</p> 
...
<a href="../chapter4/4_3_3dissectingtheemployeeclass.jsp"> << Previous</a>
<a href="../TableOfContentJava.jsp"> TOC </a>
<a href="../chapter4/4_3_5implicitandexplicitparameters.jsp">Next >> </a>
