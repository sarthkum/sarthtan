...
<title>cHAPTER 4 iMPLICIT AND eXPLICIT pARAMETERS</title>
<% session.setAttribute("key","4_3_5");%>
</head>
<div id="menu">
<ul>
...
<td>
<div id="post">
<h3>cHAPTER 4 iMPLICIT AND eXPLICIT pARAMETERS</h3>
<p>Methods operate on objects and access their instance field. For example </p> 
...
<p>It sets new value for the speed instance field in the object on which this method is invoked  </p> 
...
<p>The effect is that we want to increase the speed by speed unit through the staement. </p> 

 

<pre>  this.speed = this.speed + speed;</pre> 

 

<p>The method rasieSpeed() method  has two type of parameter implicit parameter and explicit parameter. The implicit parameter is the object of type Horse that appears before the method name.The explicit parameter are the ones which are inside the brackets after the method </p> 
...
<p>As you can see the explicit parameters are listed in the method declaration. While implicit parameters are accessed through this keyword.</p> 

 

<p>In this version, the names of the parameters are the same as the names of the instance variables, thus hiding them. However, this is used to "uncover" the instance variables</p> 
...
<a href="../chapter4/4_3_4firststepswithconstructors.jsp"> << Previous</a>
<a href="../TableOfContentJava.jsp"> TOC </a>
<a href="../chapter4/4_3_6benefitsofencapsulation.jsp">Next >> </a>
