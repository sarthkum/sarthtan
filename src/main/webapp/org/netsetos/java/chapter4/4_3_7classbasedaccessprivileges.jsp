...
<title>cHAPTER 4 cLASSbASED aCCESS pRIVILEGES</title>
<% session.setAttribute("key","4_3_7");%>
</head>
<div id="menu">
<ul>
...
<td>
<div id="post">
<h3>cHAPTER 4 cLASSbASED aCCESS pRIVILEGES</h3>
<p>You know that a method can access the private data of the object on which it is invoked. What many people find surprising is that </p> 
...
String name = ""; 
    ...
    public boolean equals(CheckEquals chkeq) { 

        return name.equals(chkeq.getName()); 
 ...
 <pre> 
    ...
    public CheckEquals(String name, int age, int salary) { 
    ...
    public static void main(String ...s){ 
        ...
        CheckEquals chk1 = new CheckEquals("Sarthak", 29, 10000); 

        CheckEquals chk2 = new CheckEquals("Sarthak", 29, 500000); 
...
<a href="../chapter4/4_3_6benefitsofencapsulation.jsp"> << Previous</a>
<a href="../TableOfContentJava.jsp"> TOC </a>
<a href="../chapter4/4_3_8privatemethods.jsp">Next >> </a>
