...
<title>cHAPTER 4 cALLING aNOTHER cONSTRUCTOR</title>
<% session.setAttribute("key","4_6_6");%>
</head>
<div id="menu">
<ul>
...
<td>
<div id="post">
<h3>cHAPTER 4 cALLING aNOTHER cONSTRUCTOR</h3>
<p>The keyword this refers to the implicit parameter of a method. However, this keyword has a second meaning.</p> 
...
<pre> 
    ...
    public Horse(int size, String color) { 

        this(size,color,16,"Arabic"); 
...
<p>Using the this keyword in this manner is useful you only need to write common construction code once.  </p> 
...
<a href="../chapter4/4_6_5parameternames.jsp"> << Previous</a>
<a href="../TableOfContentJava.jsp"> TOC </a>
<a href="../chapter4/4_6_7initializationblocks.jsp">Next >> </a>
