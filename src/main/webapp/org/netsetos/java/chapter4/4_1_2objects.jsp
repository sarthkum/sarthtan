...
<% session.setAttribute("key","4_1_2");%>
</head>
<div id="menu">
<ul>
...
<td>
<div id="post">
<h3>cHAPTER 4 oBJECTS</h3>
<p>There are three important aspect of OOPS </p> 

 

<ol> 

<li>  The objects behavior  what can you do with this object or what methods you can apply to it.</li> 

<li> The objects state  how does the object reacts when you invoke methods </li> 

<li> The objects identity how is the object distinguished from other that may have a same behavior and state .</li> 

</ol> 

 

<p>The first point is identified by methods or verb doing </p> 

<p>The second point is identified with the instance field </p> 

 

 

<p>All objects that are instance of the same class share a familiar resemblance as they support same behavior or methods </p> 

 

<p>All objects store information about who they currently look like. The is called the object's state. We can change  the objects state with methods. But without method calling if its state is changing than we have somewhere broke the encapsulation .</p> 

 

<p>However the state of object does not completely describes because each object has its distinct identity as an example two guys buys  badminton from amazon the order cart for varenya and daroga will contain badminton only or the state will remain same but in actual they are different in identity</p> 

 

<p>The key character can influence other like the objects state can influence its behavior. Like if the order is dispatched you can ignore the method call for add or remove item.</p> 
...
<a href="../chapter4/4_1_1classes.jsp"> << Previous</a>
<a href="../TableOfContentJava.jsp"> TOC </a>
<a href="../chapter4/4_1_3identifyingclasses.jsp">Next >> </a>
