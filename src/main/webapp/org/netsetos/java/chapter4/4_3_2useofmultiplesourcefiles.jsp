...
<title>cHAPTER 4 uSE OF mULTIPLE sOURCE fILES</title>
<% session.setAttribute("key","4_3_2");%>
</head>
<div id="menu">
<ul>
...
<td>
<div id="post">
<h3>cHAPTER 4 uSE OF mULTIPLE sOURCE fILES</h3>
<p>We will make a convention that we will place all class files in separate java files . We can put them in a single file also with public modifier for the class we want to save as source file </p> 

 

<pre>Javac Horse*.java </pre> 

 

<p>It will compile all the classes for our case . If you have make a reference of Horse class in HorseTest class than compiling the HorseTest will compile the Horse class also just like make command in unix</p> 
...
<a href="../chapter4/4_3_1anemployeeclass.jsp"> << Previous</a>
<a href="../TableOfContentJava.jsp"> TOC </a>
<a href="../chapter4/4_3_3dissectingtheemployeeclass.jsp">Next >> </a>
