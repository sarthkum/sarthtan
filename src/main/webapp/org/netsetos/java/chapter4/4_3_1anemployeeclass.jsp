...
<title>cHAPTER 4 aN eMPLOYEE cLASS</title>
<% session.setAttribute("key","4_3_1");%>
</head>
<div id="menu">
<ul>
...
<td>
<div id="post">
<h3>cHAPTER 4 aN Horse cLASS</h3>
<p>Here we will define a simple java class you can also define your own class also. Class is just think of anything you want to represent like an Employee, Song, Ball, Chapter, Course. </p> 

<p>Like anything you want to do like you want to make a Payment Gateway for your application  for that you can describe a class PaymentGateway.</p> 

 

<p>Next thing you want that class to perform some action like if Dog is a class than bark, breed, eat etc can be decided as methods in java for the action performed by Dog  and attribute like size, color etc which will be used for describing a Dog features are called instance variables.</p> 
...
<p>Here we have tried to use our some knowledge which we have accuried while going through the prevoius chapters. </p> 

 

<p>Described a class named Horse so created a class named Horse in package chap.multi </p> 

 

<p>Just think what horse is made of like how will you identify a horse like </p> 

 

<p>Yes you are right color, size, speed, age, breed etc so we define the instance variable accordingly  </p> 
...
<p>Next what now its time to get some actions from the class- verb doing action like </p> 

<p>sound() , race() , poloGame() etc.</p> 

 

<p>But wait we first want Horse object to be created before we put it to some work or action </p> 

 

<pre> 

Horse(int size,String color,int speed,String breed)   

new Horse(16,"Brown",100,"Arbaic"); 
...
public class Horse { 
    ...
    L:ocalDate localdate; 

 

    private void rasieSpeed(int speed) { 

        this.speed = this.speed+speed; 

    } 

    enum Sound {neigh, snort, whinny, nicker};  
...
<p>Compile the class as described previously </p> 

 

<pre>javac HorseTest.java</pre> 

 

<p>Next, when you compile this source code, the compiler creates two class files in the directory: HorseTest.class and Horse.class.</p> 

<p>You then start the program by giving the bytecode interpreter the name of the class that contains the main method of your program:</p> 

<pre>java HorseTest</pre> 

<p>The bytecode interpreter starts running the code in the main method in the HorseTest class. This code in turn constructs four new HorseTest objects and shows you their state.</p> 
...
<a href="../chapter4/4_3definingyourownclasses.jsp"> << Previous</a>
<a href="../TableOfContentJava.jsp"> TOC </a>
<a href="../chapter4/4_3_2useofmultiplesourcefiles.jsp">Next >> </a>
