...
<title>cHAPTER 4 sTATIC iMPORTS</title>
<% session.setAttribute("key","4_7_2");%>
</head>
<div id="menu">
<ul>
...
<td>
<div id="post">
<h3>cHAPTER 4 sTATIC iMPORTS</h3>
<p>A form of the import statement permits the importing of static method and fields, not just classes</p> 

 

<pre>import static java.lang.System.*;</pre> 

 

<p>to the top of your source file, then you can use the static methods and fields of the System class without the class name prefix</p> 

 

<pre> 

out.println("Creating Water Vaccum "); 
...
<p>You can also import the Math class so that all functions might be clear</p> 

 

<pre>sqrt(pow(x, 2) + pow(y, 2))</pre> 
...
<pre>Math.sqrt(Math.pow(x, 2) + Math.pow(y, 2))</pre> 
...
<a href="../chapter4/4_7_1classimportation.jsp"> << Previous</a>
<a href="../TableOfContentJava.jsp"> TOC </a>
<a href="../chapter4/4_7_3additionofaclassintoapackage.jsp">Next >> </a>
