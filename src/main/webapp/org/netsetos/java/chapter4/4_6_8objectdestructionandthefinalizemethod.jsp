...
<title>cHAPTER 4 oBJECT dESTRUCTION AND THE FINALIZE mETHOD</title>
<% session.setAttribute("key","4_6_8");%>
</head>
<div id="menu">
<ul>
...
<td>
<div id="post">
<h3>cHAPTER 4 oBJECT dESTRUCTION AND THE FINALIZE mETHOD</h3>
<p>Of course, some objects utilize a resource other than memory, such as a file or a handle to another object that uses system resources. In this case, it is important that the resource be reclaimed and recycled when it is no longer needed.</p> 

 

<p>You can add a finalize method to any class. The finalize method will be called before the garbage collector sweeps away the object. In practice, do not rely on the finalize method for recycling any resources that are in short supply you simply cannot know when this method will be called.</p> 
...
<a href="../chapter4/4_6_7initializationblocks.jsp"> << Previous</a>
<a href="../TableOfContentJava.jsp"> TOC </a>
<a href="../chapter4/4_7packages.jsp">Next >> </a>
