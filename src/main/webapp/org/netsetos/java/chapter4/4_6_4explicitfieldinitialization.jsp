...
<title>cHAPTER 4 eXPLICIT fIELD iNITIALIZATION</title>
<% session.setAttribute("key","4_6_4");%>
</head>
<div id="menu">
<ul>
...
<td>
<div id="post">
<h3>cHAPTER 4 eXPLICIT fIELD iNITIALIZATION</h3>
<p>By overloading the constructor methods in a class, you can build many ways to setup the instance fields of your class.</p> 

 

<p>It is always a good idea to make sure that, regardless of the constructor call</p> 

 

<p>You can simply assign a value to any field in the class defination.</p> 

 

<pre> 

   private int asignid = getAssignID(); 

   private static int nextID; 

 

    private static int getAssignID() { 
...
<a href="../chapter4/4_6_3theconstructorwithnoarguments.jsp"> << Previous</a>
<a href="../TableOfContentJava.jsp"> TOC </a>
<a href="../chapter4/4_6_5parameternames.jsp">Next >> </a>
