...
<title>cHAPTER 4 mUTATOR AND aCCESSOR mETHODS</title>
<% session.setAttribute("key","4_2_3");%>
</head>
<div id="menu">
<ul>
...
<td>
<div id="post">
<h3>cHAPTER 4 mUTATOR AND aCCESSOR mETHODS</h3>
...
<pre>GregorianCalendar someDay = new GregorianCalendar(1962,11,9); 
...
<pre>LocalDate date = LocalDate.now();</pre> 
...
<pre>date = date.minusDays(today - 1); // Set to start of month 
...
<a href="../chapter4/4_2_2thelocaldateclassofthejavalibrary.jsp"> << Previous</a>
<a href="../TableOfContentJava.jsp"> TOC </a>
<a href="../chapter4/4_3definingyourownclasses.jsp">Next >> </a>
