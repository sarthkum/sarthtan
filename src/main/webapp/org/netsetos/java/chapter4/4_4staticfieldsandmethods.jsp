...
<title>cHAPTER 4 sTATIC fIELDS AND mETHODS</title>
<% session.setAttribute("key","4_4");%>
</head>
<div id="menu">
<ul>
...
<td>
<div id="post">
<h3>cHAPTER 4 sTATIC fIELDS AND mETHODS</h3>
<p>In all sample programs that you have seen, the main method is tagged with the static modifier. We are now ready to discuss the meaning of this modifier</p>
...
<a href="../chapter4/4_3_9finalinstancefields.jsp"> << Previous</a>
<a href="../TableOfContentJava.jsp"> TOC </a>
<a href="../chapter4/4_4_1staticfields.jsp">Next >> </a>
