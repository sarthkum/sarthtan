...
<title>cHAPTER 4 pACKAGE sCOPE</title>
<% session.setAttribute("key","4_7_4");%>
</head>
<div id="menu">
<ul>
...
<td>
<div id="post">
<h3>cHAPTER 4 pACKAGE sCOPE</h3>
<p>You have already encountered the access modifier public and private. 
Features tagged as public can be used by any class and private features can be used only by the class that defines them.  

</p> 

<p>If you do not specify any public or private accessor than it is default and it can be accessed by all the methods in the same package.</p> 
...
<a href="../chapter4/4_7_3additionofaclassintoapackage.jsp"> << Previous</a>
<a href="../TableOfContentJava.jsp"> TOC </a>
<a href="../chapter4/4_8theclasspath.jsp">Next >> </a>
