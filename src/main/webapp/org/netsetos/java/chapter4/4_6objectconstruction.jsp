...
<title>cHAPTER 4 oBJECT cONSTRUCTION</title>
<% session.setAttribute("key","4_6");%>
</head>
<div id="menu">
<ul>
...
<td>
<div id="post">
<h3>cHAPTER 4 oBJECT cONSTRUCTION</h3>
<p>You have seen how to write simple constructors that define the initial state of your objects.
 However, since object construction is so important, Java offers quite a variety of mechanisms for writing constructors. We go over these mechanisms in the sections that follow.</p>
...
<a href="../chapter4/4_5methodparameters.jsp"> << Previous</a>
<a href="../TableOfContentJava.jsp"> TOC </a>
<a href="../chapter4/4_6_1overloading.jsp">Next >> </a>
