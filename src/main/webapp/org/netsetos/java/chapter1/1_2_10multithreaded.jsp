...
<title>cHAPTER 1 mULTITHREADED</title> 
<% session.setAttribute("key","1_2_10");%>
</head>
<div id="menu">
<ul>
...
<div class="panel">
<p><a href="../chapter1/1_2thejavawhitepaperbuzzwords.jsp">tHE jAVA wHITE pAPER bUZZWORDS</a></p><p><a href="../chapter1/1_2_1multithreaded.jsp">mULTITHREADED</a></p>
...
<td>
<div id="post">
<h3>cHAPTER 1 mULTITHREADED</h3>
<p>"Benefit of multithreaded are better interactive responsiveness and real time behaviour"</p> 

<p>Now a days we care about concurrency more as moore's law is coming to an end , Instead of faster processor we are giving more processors and we have to keep them busy. Yet languages are yet to be modified for this. </p> 

 

<p>But java is well ahead of  times and is first main language to support concurrent programming , Though they have started it not for processors as they are very rare at that time but for web request and response form the browsers as the user response freeze when it is waiting for server response .</p>
...
<a href="../chapter1/1_2_11dynamic.jsp">Next >> </a>
