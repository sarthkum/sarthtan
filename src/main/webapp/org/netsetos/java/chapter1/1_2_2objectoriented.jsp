...
<title>cHAPTER 1 oBJECToRIENTED</title>
<% session.setAttribute("key","1_2_2");%>
</head>
<div id="menu">
<ul>
...
<td>
<div id="post">
<h3>cHAPTER 1 oBJECToRIENTED</h3>
<p>Java is one of the  Object Oriented language others are C++,Python .While C is a procedural  language which is based on functions and not on class design or objects.</p> 

<p>Java is not purely object oriented as it uses primitive data types like int ,long ,double etc , Pure objected oriented language like small talk , objective c (Apple) are pure object oriented as everything there is in form of objects only.</p> 

<p>There is a concept of functional programming also which java has included in java 7 as lambda expression and try to bridge the gap between Scala and Java as in pure functional language you can call have parameters as function also, basically it helps  with  size of code it will be more concise in functional programming. I will cover this later as for now it is fine to be only knowing keywords like object oriented , class , function , procedural will be fine <p>
...
<a href="../chapter1/1_2_11dynamic.jsp"> << Previous</a>
<a href="../TableOfContentJava.jsp"> TOC </a>
<a href="../chapter1/1_2_3distributed.jsp">Next >> </a>
