...
<title>cHAPTER 14 lOCK tESTING AND tIMEOUTS</title>
<% session.setAttribute("key","14_5_13");%>
</head>
<div id="menu">
<ul>
...
<td>
<div id="post">
<h3>cHAPTER 14 lOCK tESTING AND tIMEOUTS</h3>
...
<a href="../chapter14/14_5_12threadlocalvariables.jsp"> << Previous</a>
<a href="../TableOfContentJava.jsp"> TOC </a>
<a href="../chapter14/14_5_14readwritelocks.jsp">Next >> </a>
