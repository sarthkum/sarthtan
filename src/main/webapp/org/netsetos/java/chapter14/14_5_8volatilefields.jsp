...
<title>cHAPTER 14 vOLATILE fIELDS</title>
<% session.setAttribute("key","14_5_8");%>
</head>
<div id="menu">
<ul>
...
<td>
<div id="post">
<h3>cHAPTER 14 vOLATILE fIELDS</h3>
...
<a href="../chapter14/14_5_7themonitorconcept.jsp"> << Previous</a>
<a href="../TableOfContentJava.jsp"> TOC </a>
<a href="../chapter14/14_5_9finalvariables.jsp">Next >> </a>
