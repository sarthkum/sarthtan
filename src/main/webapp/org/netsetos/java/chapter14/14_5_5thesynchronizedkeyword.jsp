...
<title>cHAPTER 14 tHE SYNCHRONIZED kEYWORD</title>
<% session.setAttribute("key","14_5_5");%>
</head>
<div id="menu">
<ul>
...
<td>
<div id="post">
<h3>cHAPTER 14 tHE SYNCHRONIZED kEYWORD</h3>
...
<a href="../chapter14/14_5_4conditionobjects.jsp"> << Previous</a>
<a href="../TableOfContentJava.jsp"> TOC </a>
<a href="../chapter14/14_5_6synchronizedblocks.jsp">Next >> </a>
