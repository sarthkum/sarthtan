...
<title>cHAPTER 10 wORKING WITH 2d sHAPES</title>
<% session.setAttribute("key","10_5");%>
</head>
<div id="menu">
<ul>
...
<td>
<div id="post">
<h3>cHAPTER 10 wORKING WITH 2d sHAPES</h3>
...
<a href="../chapter10/10_4displayinginformationinacomponent.jsp"> << Previous</a>
<a href="../TableOfContentJava.jsp"> TOC </a>
<a href="../chapter10/10_6usingcolor.jsp">Next >> </a>
