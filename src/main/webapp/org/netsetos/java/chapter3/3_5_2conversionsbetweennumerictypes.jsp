...
<title>cHAPTER 3 cONVERSIONS BETWEEN nUMERIC tYPES</title>
<% session.setAttribute("key","3_5_2");%>
</head>
<div id="menu">
<ul>
...
<td>
<div id="post">
<h3>cHAPTER 3 cONVERSIONS BETWEEN nUMERIC tYPES</h3>
<p>It is often necessary to convert from numeric type to another numeric type </p> 

 

 

<img src="img/convertchap3.jpg" height="80%" width="80%"/><br>  

 

<p>These solid lines represent conversion without any loss of information and three lines with dots are the one where there is a chance that information will be lost </p> 
...
<p>Some precision will be lost in the lossy conversion.</p> 

 

<p>When some binary operation are performed on operands than before operations they are converted to a common type like x = i +f ; where I is a integer and f is a float</p> 

 

<ul> 

<li>If either of the operand is double than other one is converted to double.</li> 

<li>If either of the operand is float than other one is converted to float </li> 

<li>If either of the operand is long than other one is converted to long</li> 

<li>If otherwise than converted to int   </li> 
...
<a href="../chapter3/3_5_1mathematicalfunctionsandconstants.jsp"> << Previous</a>
<a href="../TableOfContentJava.jsp"> TOC </a>
<a href="../chapter3/3_5_3casts.jsp">Next >> </a>
