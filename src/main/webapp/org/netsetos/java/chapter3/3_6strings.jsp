...
<title>cHAPTER 3 sTRINGS</title>
<% session.setAttribute("key","3_6");%>
</head>
<div id="menu">
<ul>
...
<td>
<div id="post">
<h3>cHAPTER 3 sTRINGS</h3>
<p>In java String are a series of Unicode characters  netsetos\u2122 contains 9 characters . Java does not have a built in String type , Instead java contains a  predefined java class. </p> 

 

<pre>String empty = ""; 

String hellonetsetos = "Hello Netsetos"</pre>
...
<a href="../chapter3/3_5_9enumeratedtypes.jsp"> << Previous</a>
<a href="../TableOfContentJava.jsp"> TOC </a>
<a href="../chapter3/3_6_1substrings.jsp">Next >> </a>
