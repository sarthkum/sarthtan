...
<title>cHAPTER 3 iNPUT AND oUTPUT</title>
<% session.setAttribute("key","3_7");%>
</head>
<div id="menu">
<ul>
...
To make our program more interesting we want to accept input and properly format the program output. However the latest application involves GUI, </p><p>But for the testing purpose in big application and for the sake of convenience we will try to find out ways to read input and format output .</p>
...
<a href="../chapter3/3_6_9buildingstrings.jsp"> << Previous</a>
<a href="../TableOfContentJava.jsp"> TOC </a>
<a href="../chapter3/3_7_1readinginput.jsp">Next >> </a>
