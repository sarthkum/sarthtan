...
<title>cHAPTER 3 iNCREMENT AND dECREMENT oPERATORS</title>
<% session.setAttribute("key","3_5_5");%>
</head>
<div id="menu">
<ul>
...
<td>
<div id="post">
<h3>cHAPTER 3 iNCREMENT AND dECREMENT oPERATORS</h3>
<p>This is one of the most important opeartors that we encounter while programming that to increment a value by one </p> 
...
<p>It will change the value to 3 . There are two form of these operators one is postfix and other is prefix , I would recommed to use only one form inside expression as it will be annoying and troublesome while debugging </p> 
...
int z  = 4 * ++x; value will 32 

Int k = 4 * y++ ; value will be 28 
...
<a href="../chapter3/3_5_4combiningassignmentwithoperators.jsp"> << Previous</a>
<a href="../TableOfContentJava.jsp"> TOC </a>
<a href="../chapter3/3_5_6relationalandbooleanoperators.jsp">Next >> </a>
