...
<title>cHAPTER 3 tHE sTRING api</title>
<% session.setAttribute("key","3_6_7");%>
</head>
<div id="menu">
<ul>
...
<td>
<div id="post">
<h3>cHAPTER 3 tHE sTRING api</h3>
<p>The String class in java has more than 50 methods. Surprisingly all  of them are quite useful.</p> 

 

<p>char charAt(int index)</p> 

<p>int codePointAt(int index)</p> 

<p>int offsetsByCodePoints(int startIndex , int cpCount)</p> 

<p>int compareTo(String other)</p> 

<p>Instream codePoints()</p> 

<p>Returns the code points of this string as a stream Call toArray to put them in a array </p> 

 

<p>new String(int [] codePoints , int offsets, int count);</p> 

 

<p>boolean equals(Object other)</p> 

<p>boolean equalsIgnoreCase(String other) </p> 
...
<p>int index(int cp)</p> 

 

<p>int index(int cp , int fromIndex)</p> 
...
<p>int lastIndexOf(int cp)</p> 

<p>int lastIndexOf(int cp , int fromIndex)</p> 

 

<p>int length ()</p> 

<p>int codePointCount(int startIndex,int endIndex) </p> 

<p>Returns the number of code points between startIndex and endIndex 1 </p> 

 

<p>String replace(CharacterSequence oldSequence,CharacterSequence newSequence)</p> 
...
<p>String join(CharSequence delimiter, CharSequence... elements) java 8</p> 
...
<a href="../chapter3/3_6_6codepointsandcodeunits.jsp"> << Previous</a>
<a href="../TableOfContentJava.jsp"> TOC </a>
<a href="../chapter3/3_6_8readingtheonlineapidocumentation.jsp">Next >> </a>
