...
<title>cHAPTER 3 iNTEGER tYPES</title>
<% session.setAttribute("key","3_3_1");%>
</head>
<div id="menu">
<ul>
...
<td>
<div id="post">
<h3>cHAPTER 3 iNTEGER tYPES</h3>
<p>Integer type are for numbers which do not have fractional part Java has four types of integer data type </p> 
<img src="img/getfile.jpeg" height="80%" width="80%"/> 
<p>You can see the 4 primitive data types like different type size of glasses of lassi like</p>  
<p><b>cutting,chota , bada and patiala as byte ,short,int,long </b>. You can use different type according to your  requirement to represent</p> 
<img src="img/glassinttolong.jpeg" height="80%" width="80%"/> 
<p>Java data types are not dependent on platform on which you are programming that alleviates a major pain 
 for programmers who are like trying to shift to other platform.Like C or C++ code running on one machine might not work on other machine </p> 
 <p>In C or C++ it will take most efficient underlying structure like programs working fine in 64 bit system might not work good in 
 32 or 16 bit system</p> 
 <p>Long integer might be added with a suffix l or L (like 40000000L),Hexadecimal Number have a prefix like 0x or 0X as 0xCAFE</p> 
 <pre>int hexacheck  =  0xCAFE; 
 // will print 51966</pre> 
  
 <p>From Java 7 we can write number as in binary form as prefix with 0b or 0B like for 8 as 0b1000</p> 
 <pre>int bincheck = 0B0010; 
 // it will print 2 </pre> 
 <p>from java 7 we can represent number as 1_000_000_or 0b1111_0010_0010_0011 java compiler simply removes underscore </p> 
 <pre>int underscore_check = 1_000_000; 
 // print 1000000</pre>
...
<a href="../chapter3/3_3datatypes.jsp"> << Previous</a>
<a href="../TableOfContentJava.jsp"> TOC </a>
<a href="../chapter3/3_3_2floatingpointtypes.jsp">Next >> </a>
