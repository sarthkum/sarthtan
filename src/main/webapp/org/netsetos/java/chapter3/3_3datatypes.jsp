...
<p> Java is strong Typed Language which means that every variable should have a type associated with it  </p> 
<p>Variable comes into two flavors primitive and reference variables which ranges from primitive like int,float to  
complex types as String Array</p> 
<p>In java we have two type of data type in java one is primitive and another is reference variables for objects.</p> 
<p>There are 8 primitive data type which can be divided as <b>4 are of Integer Types</b> , <b>2</b> are of <b>float type</b> , <b>one is char</b> </p>  
<p>type,and <b>one</b> is for representing true or false values <b>boolean type</b> </p> 
...
<a href="../chapter3/3_2comments.jsp"> << Previous</a>
<a href="../TableOfContentJava.jsp"> TOC </a>
<a href="../chapter3/3_3_1integertypes.jsp">Next >> </a>
