...
<title>cHAPTER 3 eNUMERATED tYPES</title>
<% session.setAttribute("key","3_5_9");%>
</head>
<div id="menu">
<ul>
...
<td>
<div id="post">
<h3>cHAPTER 3 eNUMERATED tYPES</h3>
<p>Sometime a variable should hold only restricted values only . Suppose you sell cloth or pizza only in four size only like SMALL, MEDIUM, LARGE, EXTRA_LARGE</p> 

 

<pre>enum Size { SMALL, MEDIUM, LARGE, EXTRA_LARGE };</pre> 

 

<pre>Size s = Size.MEDIUM;</pre> 

 

<p>A variable of type Size can hold only one of the values listed in the type declaration, or the special value null that indicates </p>
<p>that the variable is not set to any value at all.</p>
...
<a href="../chapter3/3_5_8parenthesesandoperatorhierarchy.jsp"> << Previous</a>
<a href="../TableOfContentJava.jsp"> TOC </a>
<a href="../chapter3/3_6strings.jsp">Next >> </a>
