...
<title>cHAPTER 3 cASTS</title>
<% session.setAttribute("key","3_5_3");%>
</head>
<div id="menu">
<ul>
...
<td>
<div id="post">
<h3>cHAPTER 3 cASTS</h3>
<p>I the previous topic the value are automatically cast for  one datatype to another datatype like values are implicitly converted to double . But there may be situations where you need to convert a double to int . Numeric conversion are possible in java but information will be lost . The cast in which information loss is possible is done through cast.</p> 
...
<p>Now the variable ny has value 8 because casting to int from floating point will discard the fractional part</p> 

 

<p>Now if you want the number to be rounded to the nearest integer use Math round Method </p> 

<pre> 

double z = 17.990 

int xz  =  (int)Math.round(z); 

</pre> 

 

<p>Now the value xz has value 18 but we still need to cast it to int as return type of round function is long.</p> 
...
<a href="../chapter3/3_5_2conversionsbetweennumerictypes.jsp"> << Previous</a>
<a href="../TableOfContentJava.jsp"> TOC </a>
<a href="../chapter3/3_5_4combiningassignmentwithoperators.jsp">Next >> </a>
