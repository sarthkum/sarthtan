...
<title>cHAPTER 3 eMPTY AND nULL sTRINGS</title>
<% session.setAttribute("key","3_6_5");%>
</head>
<div id="menu">
<ul>
...
<td>
<div id="post">
<h3>cHAPTER 3 eMPTY AND nULL sTRINGS</h3>
<p>The empty string "" is of length 0 </p> 
...
<p>A empty string in java contains a string of length 0 and an empty content,However String can also hold a special value null which means that no Object is currently associated with it </p> 

 

<pre>If(str == null){  // You cannot use equals method as null pointer exception will come  
...
<p>If you want to work on both check whether string is null or string is empty than use </p> 
...
<p>We need to check the null condition first </p> 
...
<a href="../chapter3/3_6_4testingstringsforequality.jsp"> << Previous</a>
<a href="../TableOfContentJava.jsp"> TOC </a>
<a href="../chapter3/3_6_6codepointsandcodeunits.jsp">Next >> </a>
