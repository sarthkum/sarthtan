...
<title>cHAPTER 3 bUILDING sTRINGS</title>
<% session.setAttribute("key","3_6_9");%>
</head>
<div id="menu">
<ul>
...
<td>
<div id="post">
<h3>cHAPTER 3 bUILDING sTRINGS</h3>
<p>Occasionally we need to build a string from many shorter Strings , such as keystrokes or words from a file. It would we inefficient to use String  concatenation for the purpose. Every time you concatenate string a new String object is created . This is time consuming and waste of memory. We can use StringBuilder class for this purpose.</p> 

 

<p>Every time you need to add some string use append method .</p> 

 

<pre>builder.append(ch) 
...
<p>When you are done call the toString() method.</p> 

 

<pre>String completedString = builder.toString();</pre> 

 

<p>StringBuilder is introduced in 5th version previously we use StringBuffer that is slightly less efficient but is thread Safe.</p> 
...
<p>StringBuilder append(String s)</p> 

 

<p>StringBuilder append(Char c)</p> 

 

<p>StringBuilder appendCodePoint(int cp)</p> 

 

<p>void setCharAt(int i . char c)</p> 
...
<p>StringBuilder insert(int offset , char c)</p> 

 

<p>StringBuilder delete(int startIndex,int endindex)</p> 
...
<a href="../chapter3/3_6_8readingtheonlineapidocumentation.jsp"> << Previous</a>
<a href="../TableOfContentJava.jsp"> TOC </a>
<a href="../chapter3/3_7inputandoutput.jsp">Next >> </a>
