...
<title>cHAPTER 3 rEADING THE oNLINE api dOCUMENTATION</title>
<% session.setAttribute("key","3_6_8");%>
</head>
<div id="menu">
<ul>
...
<td>
<div id="post">
<h3>cHAPTER 3 rEADING THE oNLINE api dOCUMENTATION</h3>
<a href="https://docs.oracle.com/javase/tutorial/java/data/strings.html">String docs</a>
...
<a href="../chapter3/3_6_7thestringapi.jsp"> << Previous</a>
<a href="../TableOfContentJava.jsp"> TOC </a>
<a href="../chapter3/3_6_9buildingstrings.jsp">Next >> </a>
