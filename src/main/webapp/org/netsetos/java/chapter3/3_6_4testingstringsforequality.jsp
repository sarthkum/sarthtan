...
<title>cHAPTER 3 tESTING sTRINGS FOR eQUALITY</title>
<% session.setAttribute("key","3_6_4");%>
</head>
<div id="menu">
<ul>
...
<td>
<div id="post">
<h3>cHAPTER 3 tESTING sTRINGS FOR eQUALITY</h3>
<p>To test whether two strings are equal use equals method like below </p> 
...
<p>Returns true if both Strings are equal. False otherwise .s and t can be string literals or strings value also</p> 

 

<pre>"HelloNetsetos".equals(message); </pre> 

 

<p>If you want to compare the two string while ignoring the case use equalIgnoreCase() method </p> 

 

<pre>"HelloNetsetos".equalIgnoreCase("hellonetsetos");</pre> 

 

<p>Do  not use the == operator while testing the equality of a string as it only checks whether both strings are stored in same location or not so </p> 

 

<pre>"HelloNetsetos" == "HelloNetsetos" returns true  

String message = "HelloNetsetos"; 

 

If(message == "HelloNetsetos"){ // returns true 

} 

 

If(message.substring(5,13) == "Netsetos"){ // might return false 
...
<p>If the virtual machine always arrange for equal strings to be shared then you could use the == operator for testing equality. But only string literal are shared not strings that are part of operation like + or substring . So never use == to compare the Strings .</p> 
...
<a href="../chapter3/3_6_3stringsareimmutable.jsp"> << Previous</a>
<a href="../TableOfContentJava.jsp"> TOC </a>
<a href="../chapter3/3_6_5emptyandnullstrings.jsp">Next >> </a>
