...
<title>cHAPTER 3 sUBSTRINGS</title>
<% session.setAttribute("key","3_6_1");%>
</head>
<div id="menu">
<ul>
...
<td>
<div id="post">
<h3>cHAPTER 3 sUBSTRINGS</h3>
<p>You can extract a part of String from a larger String according to various requirement through substring method of String class</p> 

 

<pre>String helloNetsetos  = "Hellonetsetos" 

helloNetsetos.substring(5,13) will print netsetos</pre> 

 

<p>The second parameter of substring is the first position that you do not want to copy , In our case we want to copy position 5,6,7,8,9,10,11,12</p> 

 

<p>There is one advantage substring works you can easily found length of substring like 13-5 simple</p>
...
<a href="../chapter3/3_6strings.jsp"> << Previous</a>
<a href="../TableOfContentJava.jsp"> TOC </a>
<a href="../chapter3/3_6_2concatenation.jsp">Next >> </a>
